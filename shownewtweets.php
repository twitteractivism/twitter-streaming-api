...
/**
* shownewtweets.php
* For displaying details of latest 500 tweets for keywords or keyword combinations chosen by admin
...
<title> Show Latest Tweets by keywords, verifiable by any citizen</title>
<script src="https://use.fontawesome.com/6d44475886.js"></script>
<meta name="keywords"content="">

<meta name="description"content="<?php echo  Cause; ?> - Latest 500 tweets having particular keywords">
...
<div class="login_panel login_panel_tweetlist">
	...
	else
	{
		if(count($locationArr) > 1){
		 $query = $query. "and((location LIKe '%".implode("%' or location LIKE '%", $locationArr)."%') or (description  LIKE '%".implode("%' or description LIKE '%", $locationArr)."%')) " .   "order by created_at desc";
		}
		else
		{
	...
	?>
		...
		<a href="tweetcount.php">Return to tweet count page</a>
